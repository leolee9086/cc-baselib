<template>
    <div>
        ...
        <div v-if="展开" style="margin:5px 0px" v-for="item in blocklist">
            ...
            <div style=" font-size: x-small;margin:5px 0px;color:gray;max-height:3em;overflow: hidden;text-overflow:ellipsis;" v-for=" block in item.blocks">
                <el-tooltip effect="dark" content="复制到剪贴板" placement="top-start">
