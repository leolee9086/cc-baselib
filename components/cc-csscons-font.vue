<template>
    <div id =root>
                <el-row id="font-size" :gutter="2" >
                    <el-col :span="4" :style='"font-family:{{当前字体系列}}"' class="cc-font cc-toolbar-item">
                    ...
                    <el-col :span="0.2"><div class="cc-toolbar-divider" style="height:28px"></div></el-col>
                    <el-col :span="2" class="cc-toolbar-item">
                        ...
                        <el-select
                            ...
                            style="max-width:100%;"
                        >
                            <el-option v-for="item in 字体大小序列" :value="item" :label="item"></el-option>
                        </el-select>
                        </div>
                    </el-col>
                    <el-col :span="2" class="cc-toolbar-item">
                    ...
                    <el-col :span="1" class="cc-toolbar-item">
                        <el-dropdown trigger="click">
                            <div type="primary" :style='"text-decoration-line:underline; {{下划线线型}} {{下划线颜色}}"'>
                                Aa<i class="el-icon-arrow-down el-icon--right"></i>
                            </div>
                            <el-dropdown-menu slot="dropdown" style="padding:10px">
                                <el-dropdown-item
                                v-for="item in 字体大小写对照"
                                >
                                    <div
                                    @click="当前样式对象.fontVariantCaps=item.value"
                                    >{{item.value}}</div>
                                </el-dropdown-item>
                            <el-dropdown-menu>
                        </el-dropdown>
                    ...
                    <el-col :span="1" class="cc-toolbar-item">
                        <el-dropdown trigger="click">
                            ...
                            <el-dropdown-menu slot="dropdown" style="padding:10px">
                                ...
                                <el-dropdown-item v-for="item in 文字装饰线型对照" @click="当前样式对象.textDecorationStyle=item.value">
                                    <span 
                                    :style='"text-decoration-line:underline; text-decoration-style:"+item.value+";"' 
                                ...
                                <el-dropdown-item>
                                    ...
                                    width="500"
                                    >
                                        <div slot="reference" :style="'margin:0 24px;height:28px;background-color:'+当前文字装饰线颜色"></div>
                                        <cc-color-pane
                    ...
                    <el-col :span="1" class="cc-toolbar-item">
                        <el-popover
                            trigger="click"
                            width="500">
                            <div slot="reference" :style="'color:'+当前样式对象.color+';font-weight:bolder;text-decoration:underline 4px'">A</div>
                                <cc-color-pane
                    ...
                    <el-col :span="1">
                        <el-popover
                            trigger="click"
                            width="500">
                            <div slot="reference" :style="'background-color:'+当前样式对象.backgroundColor+';width:24px;height:24px;border:solid 1px;margin:2px'"></div>
                                <cc-color-pane
                            ...
                            <el-dropdown-menu slot="dropdown" style="padding:10px">
                                ...
                                <el-dropdown-item>
                                    <el-popover
                                        ...
                                        width="500"
                                        >
                                            <div  slot="reference" :style="'border:solid 1px;margin:5 24px;height:28px;background-color:'+当前样式对象.webkitTextStrokeColor"></div>
                                        <cc-color-pane
                    ...
                    <el-col  :span="1">
                        ...
                        <div                         
                        slot="reference"
                        style="width:28px;min-height:100% !important">
...
<script>
    module.exports ={
        ...
        computed:{
            ...
            当前文字装饰线位置(){
                let 字符串 = ""
                if(this.当前文字上划线){字符串 = 字符串 + "overline"}
                if(this.当前文字下划线){字符串 = 字符串 + " underline"}
                if(this.当前文字删除线){字符串 = 字符串 + " line-through"}
                return 字符串
            },
...
<style scoped>
    ...
    .cc-toolbar-item ,.cc-toolbar-item div{
        min-height:100%;
        align-self:center;
        height:28px
            }
